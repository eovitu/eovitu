...
- 🌱 Aprendendo constantemente sobre **AWS**, **Microserviços** e **Arquitetura de Software**.
- 🎯 Foco em: **Clean Code**, **SOLID** e **Performance**.
- 💬 Pergunte-me sobre: Java, Spring, Python ou automação.
